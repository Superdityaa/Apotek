...
@include('editobat');
    <div class="container">
        <div class="row">
            ...
            <h2 class="text-center fs-5" style="font-family: 'Poppins'; margin-top:20px;">Data Obat Baru Apotek</h2>
                        ...
                        <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$show->jenis_obat}}</td>
                                    <td>{{$show->harga_obat}}</td>
                                    <td>{{$show->khasiat_obat}}</td>
                                    <td>
                                        <!-- <a href="" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editobat">Edit</a> -->
                                        <a href="/edit/{{$show->id}}" type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editproduk">Edit</a>
                                        <a href="/delete_obat/{{$show->id}}" type="submit" class="btn btn-danger">Hapus</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
